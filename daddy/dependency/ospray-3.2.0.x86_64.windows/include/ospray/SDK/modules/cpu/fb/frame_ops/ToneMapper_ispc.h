//
// fb/frame_ops/ToneMapper_ispc.h
...
extern "C" {
    ...
    extern void ToneMapper_kernelLauncher(void * __anon_parameter_0, void * __anon_parameter_1, const struct vec2ui &itemDims, const struct FrameBufferView * fbv);
#else
    extern void ToneMapper_kernelLauncher(void * __anon_parameter_0, void * __anon_parameter_1, const struct vec2ui *itemDims, const struct FrameBufferView * fbv);
#endif // ToneMapper_kernelLauncher function declaraion
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
