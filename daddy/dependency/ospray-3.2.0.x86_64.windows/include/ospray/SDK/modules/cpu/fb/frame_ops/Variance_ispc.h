...
extern "C" {
    ...
    extern void Variance_kernelLauncher(void * __anon_parameter_0, void * __anon_parameter_1, const struct vec2ui &itemDims, const struct FrameBufferView * fbv);
#else
    extern void Variance_kernelLauncher(void * __anon_parameter_0, void * __anon_parameter_1, const struct vec2ui *itemDims, const struct FrameBufferView * fbv);
#endif // Variance_kernelLauncher function declaraion
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
