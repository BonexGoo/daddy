//
// render/pathtracer/PathTracer_ispc.h
...
#ifndef __ISPC_ENUM_TransferFunctionType__
#define __ISPC_ENUM_TransferFunctionType__
...
struct FrameBuffer {
    ...
    void ( * accumulateSample)(struct FrameBuffer * fb, const struct v4_varying_ScreenSample &sample, struct RenderTaskDesc &taskDesc);
#else
    void ( * accumulateSample)(struct FrameBuffer * fb, const struct v4_varying_ScreenSample *sample, struct RenderTaskDesc *taskDesc);
...
#ifndef __ISPC_STRUCT_v4_varying_vec3i__
#define __ISPC_STRUCT_v4_varying_vec3i__
__ISPC_ALIGNED_STRUCT__(16) v4_varying_vec3i {
    __ISPC_ALIGN__(16)     int32_t x[4];
    __ISPC_ALIGN__(16)     int32_t y[4];
    __ISPC_ALIGN__(16)     int32_t z[4];
};
#endif
...
#ifndef __ISPC_STRUCT_v4_varying_ScreenSample__
#define __ISPC_STRUCT_v4_varying_ScreenSample__
__ISPC_ALIGNED_STRUCT__(16) v4_varying_ScreenSample {
    struct v4_varying_vec3i sampleID;
    struct v4_varying_vec2f pos;
    struct v4_varying_Ray ray;
    struct v4_varying_RayCone rayCone;
    struct v4_varying_vec3f rgb;
    __ISPC_ALIGN__(16)     float alpha[4];
    __ISPC_ALIGN__(16)     float z[4];
    struct v4_varying_vec3f normal;
    struct v4_varying_vec3f albedo;
    __ISPC_ALIGN__(16)     uint32_t primID[4];
    __ISPC_ALIGN__(16)     uint32_t geomID[4];
    __ISPC_ALIGN__(16)     uint32_t instID[4];
};
...
#ifndef __ISPC_STRUCT_VolumetricModel__
#define __ISPC_STRUCT_VolumetricModel__
struct VolumetricModel {
    struct Volume * volume;
    struct TransferFunction * transferFunction;
    struct __VKLObject vklIntervalContext;
    struct box3f boundingBox;
    float densityScale;
    float anisotropy;
...
#ifndef __ISPC_STRUCT_Volume__
#define __ISPC_STRUCT_Volume__
struct Volume {
    struct __VKLObject vklVolume;
    struct __VKLObject vklSampler;
    struct box3f boundingBox;
};
#endif
...
struct TransferFunction {
    enum TransferFunctionType type;
    struct box1f valueRange;
};
#endif
...
#if defined(__cplusplus)
    extern void PathTracer_renderTaskLauncher(void * __anon_parameter_0, void * __anon_parameter_1, const struct vec3ui &itemDims, struct Renderer * renderer, struct FrameBuffer * fb, struct Camera * camera, struct World * world, const uint32_t * taskIDs, const struct FeatureFlags &ff);
#else
    extern void PathTracer_renderTaskLauncher(void * __anon_parameter_0, void * __anon_parameter_1, const struct vec3ui *itemDims, struct Renderer * renderer, struct FrameBuffer * fb, struct Camera * camera, struct World * world, const uint32_t * taskIDs, const struct FeatureFlags *ff);
#endif // PathTracer_renderTaskLauncher function declaraion
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
...
#ifndef __ISPC_STRUCT_v16_varying_vec3i__
#define __ISPC_STRUCT_v16_varying_vec3i__
__ISPC_ALIGNED_STRUCT__(64) v16_varying_vec3i {
    __ISPC_ALIGN__(64)     int32_t x[16];
    __ISPC_ALIGN__(64)     int32_t y[16];
    __ISPC_ALIGN__(64)     int32_t z[16];
};
#endif
...
#ifndef __ISPC_STRUCT_v16_varying_ScreenSample__
#define __ISPC_STRUCT_v16_varying_ScreenSample__
__ISPC_ALIGNED_STRUCT__(64) v16_varying_ScreenSample {
    struct v16_varying_vec3i sampleID;
    struct v16_varying_vec2f pos;
    struct v16_varying_Ray ray;
    struct v16_varying_RayCone rayCone;
    struct v16_varying_vec3f rgb;
    __ISPC_ALIGN__(64)     float alpha[16];
    __ISPC_ALIGN__(64)     float z[16];
    struct v16_varying_vec3f normal;
    struct v16_varying_vec3f albedo;
    __ISPC_ALIGN__(64)     uint32_t primID[16];
    __ISPC_ALIGN__(64)     uint32_t geomID[16];
    __ISPC_ALIGN__(64)     uint32_t instID[16];
};
