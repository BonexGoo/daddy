...
#ifndef __ISPC_STRUCT_vec2ui__
#define __ISPC_STRUCT_vec2ui__
struct vec2ui {
    uint32_t x;
    uint32_t y;
};
...
#ifndef __ISPC_STRUCT_FrameBufferView__
#define __ISPC_STRUCT_FrameBufferView__
struct FrameBufferView {
    struct vec2ui fbDims;
    struct vec2ui viewDims;
    const struct vec4f * colorBufferInput;
    struct vec4f * colorBufferOutput;
    const float * depthBuffer;
    const struct vec3f * normalBuffer;
    const struct vec3f * albedoBuffer;
};
#endif
...
extern "C" {
    ...
    extern void BlurHorizontal_kernelLauncher(void * __anon_parameter_0, void * __anon_parameter_1, const struct vec2ui &itemDims, const struct FrameBufferView * fbv);
#else
    extern void BlurHorizontal_kernelLauncher(void * __anon_parameter_0, void * __anon_parameter_1, const struct vec2ui *itemDims, const struct FrameBufferView * fbv);
#endif // BlurHorizontal_kernelLauncher function declaraion
#if defined(__cplusplus)
    extern void BlurVertical_kernelLauncher(void * __anon_parameter_0, void * __anon_parameter_1, const struct vec2ui &itemDims, const struct FrameBufferView * fbv);
#else
    extern void BlurVertical_kernelLauncher(void * __anon_parameter_0, void * __anon_parameter_1, const struct vec2ui *itemDims, const struct FrameBufferView * fbv);
#endif // BlurVertical_kernelLauncher function declaraion
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
