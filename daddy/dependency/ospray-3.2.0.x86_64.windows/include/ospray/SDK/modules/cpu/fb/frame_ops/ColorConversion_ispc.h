//
// fb/frame_ops/ColorConversion_ispc.h
...
extern "C" {
    ...
    extern void ColorConversion_kernelLauncher(void * __anon_parameter_0, void * __anon_parameter_1, const struct vec2ui &itemDims, const struct FrameBufferView * fbv);
#else
    extern void ColorConversion_kernelLauncher(void * __anon_parameter_0, void * __anon_parameter_1, const struct vec2ui *itemDims, const struct FrameBufferView * fbv);
#endif // ColorConversion_kernelLauncher function declaraion
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
