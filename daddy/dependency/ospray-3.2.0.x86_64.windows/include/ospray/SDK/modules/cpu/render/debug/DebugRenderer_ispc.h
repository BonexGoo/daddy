//
// render/debug/DebugRenderer_ispc.h
...
#endif // __cplusplus
#if defined(__cplusplus)
    extern void DebugRenderer_renderTaskLauncher(void * __anon_parameter_0, void * __anon_parameter_1, const struct vec3ui &itemDims, struct Renderer * renderer, struct FrameBuffer * fb, struct Camera * camera, struct World * world, const uint32_t * taskIDs, const struct FeatureFlags &ff);
#else
    extern void DebugRenderer_renderTaskLauncher(void * __anon_parameter_0, void * __anon_parameter_1, const struct vec3ui *itemDims, struct Renderer * renderer, struct FrameBuffer * fb, struct Camera * camera, struct World * world, const uint32_t * taskIDs, const struct FeatureFlags *ff);
#endif // DebugRenderer_renderTaskLauncher function declaraion
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
