//
// render/distributed/DistributedRaycast_ispc.h
...
extern "C" {
#endif // __cplusplus
    extern void DistributedRaycast_renderRegionToTileTask(void * _self, void * _fb, void * _camera, void * _world, void * _region, void * perFrameData, void * _taskIDs, uint32_t numTasks);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
