...
#include "../../../../../../Views/Qt/vtkQtRecordView.h"
...
static constexpr auto qt_meta_stringdata_ZN15vtkQtRecordViewE = QtMocHelpers::stringData(
    "vtkQtRecordView"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN15vtkQtRecordViewE[] = {
...
Q_CONSTINIT const QMetaObject vtkQtRecordView::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15vtkQtRecordViewE.offsetsAndSizes,
    qt_meta_data_ZN15vtkQtRecordViewE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15vtkQtRecordViewE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<vtkQtRecordView, std::true_type>
    >,
    nullptr
} };
...
void *vtkQtRecordView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15vtkQtRecordViewE.stringdata0))
