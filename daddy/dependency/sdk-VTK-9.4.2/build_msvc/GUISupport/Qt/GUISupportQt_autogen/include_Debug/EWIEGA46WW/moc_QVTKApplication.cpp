...
#include "../../../../../../GUISupport/Qt/QVTKApplication.h"
...
static constexpr auto qt_meta_stringdata_ZN15QVTKApplicationE = QtMocHelpers::stringData(
    "QVTKApplication"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN15QVTKApplicationE[] = {
...
Q_CONSTINIT const QMetaObject QVTKApplication::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15QVTKApplicationE.offsetsAndSizes,
    qt_meta_data_ZN15QVTKApplicationE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15QVTKApplicationE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QVTKApplication, std::true_type>
    >,
    nullptr
} };
...
void *QVTKApplication::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15QVTKApplicationE.stringdata0))
