...
#include "../../../../../../GUISupport/Qt/vtkQtTreeModelAdapter.h"
...
static constexpr auto qt_meta_stringdata_ZN21vtkQtTreeModelAdapterE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN21vtkQtTreeModelAdapterE[] = {
...
Q_CONSTINIT const QMetaObject vtkQtTreeModelAdapter::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN21vtkQtTreeModelAdapterE.offsetsAndSizes,
    qt_meta_data_ZN21vtkQtTreeModelAdapterE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN21vtkQtTreeModelAdapterE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<vtkQtTreeModelAdapter, std::true_type>
    >,
    nullptr
} };
...
void *vtkQtTreeModelAdapter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN21vtkQtTreeModelAdapterE.stringdata0))
