...
DD_global("gPlanFirst", EscapePlanP, gPlanFirst, nullptr, nullptr, 0, nullptr, 0);

EscapePlanP* EscapeModel::__em_build(const EscapePlanP* super, utf8s name, uint32_t size, utf8s file, uint32_t line, InitCB icb, QuitCB qcb, MoveCB mcb, CopyCB ccb)
{
