...
SOURCES += ../source/connector.cpp
HEADERS += ../source/connector.hpp
SOURCES += ../source/telegraph.cpp
HEADERS += ../source/telegraph.hpp
SOURCES += ../source/main.cpp
SOURCES += ../source/node.cpp
HEADERS += ../source/node.hpp
SOURCES += ../source/scheduler.cpp
HEADERS += ../source/scheduler.hpp
SOURCES += ../source/webserver.cpp
HEADERS += ../source/webserver.hpp
